...
namespace ParticipantsAPI.Models
{
    ...
    public partial class INTERNEntities3 : DbContext
    {
        public INTERNEntities3()
            : base("name=INTERNEntities3")
        {
        }
        ...
        public virtual ObjectResult<GetAllParticipants_Result> GetAllParticipants()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllParticipants_Result>("GetAllParticipants");
        }
