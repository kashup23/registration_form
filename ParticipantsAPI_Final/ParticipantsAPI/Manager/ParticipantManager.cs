...
namespace ParticipantsAPI.Manager
{
    public class ParticipantManager
    {
        ...
        {
            participantRepository = new ParticipantRepository(new INTERNEntities3());
        }
        ...
        public UpdateParticipantOutput UpdateParticipant(UpdateParticipantInput objIp)
        {
            ...
            try
            {
                ...
                if (rsData != null)
                {
                    ...
                    {
                        rsOutput.Message = "Participant Updtaed sucessfully";
                        rsOutput.RespCode = HttpStatusCode.OK;
                    }
                    else if ((bool)rsData.ParticipantAlreadyExists == true)
                    {
                        rsOutput.Message = "participant With this Email or transaction password doesnot exit ";
                        rsOutput.RespCode = HttpStatusCode.BadRequest;
                    }
                    else
                    {
